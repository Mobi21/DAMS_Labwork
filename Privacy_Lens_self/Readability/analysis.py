...
def get_grammatical_errors(policy_text):
    prompt = """
    You are an advanced NLP model. Your task is to analyze a privacy policy text and identify all sentences that contain grammatical errors. Count the amount of grammatical errors in the text.
    Your output should be the frequency of grammatical errors. The frequency is calculated as:
